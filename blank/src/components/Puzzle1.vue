...
<template>
    <Page actionBarHidden="true">
        <StackLayout class="glavni">
            ...
            >
                <Image class="glavnaSlika" src="~/images/puzzleKlavir.jpg"  verticalAlignment="top" horizontalAlignment="center"/>
            </GridLayout>
...
<script>
    ...
    data() {
        ...
        boxArray: [
            ...
            row: 0,
            col: 0,
            src: "~/images/Klavir4.jpg",
            },
            {
            refId: "drag1",
            row: 0,
            col: 1,
            src: "~/images/Klavir1.jpg",
            },
            {
            refId: "drag2",
            row: 1,
            col: 0,
            src: "~/images/Klavir2.jpg",
            },
            {
            refId: "drag3",
            row: 1,
            col: 1,
            src: "~/images/Klavir3.jpg",
            },
        ],
        finalArray: [
            {
    ...
    methods: {
        ...
        if (args.state === 1) {
            ...
            if (JSON.stringify(this.boxArray) === JSON.stringify(this.finalArray)) {
                console.log("Correct.");
                ImagePopup.localImagePopup("~/images/puzzleKlavir.jpg");
                this._player.play();
                this.right = true;
            }
        }
