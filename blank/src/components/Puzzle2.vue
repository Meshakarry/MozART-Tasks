...
<template>
    <Page actionBarHidden="true">
        <StackLayout class="glavni">
            ...
            >
                <Image class="glavnaSlika" src="~/images/puzzleSaksofon.jpg"  verticalAlignment="top" horizontalAlignment="center"/>
            </GridLayout>
...
<script>
    ...
    data() {
        ...
        boxArray: [
            ...
            row: 1,
            col: 0,
            src: "~/images/Truba2.jpg",
            },
            {
            refId: "drag3",
            row: 1,
            col: 1,
            src: "~/images/Truba3.jpg",
            },
        ],
        finalArray: [
            {
    ...
    methods: {
        ...
        if (args.state === 1) {
            ...
            if (JSON.stringify(this.boxArray) === JSON.stringify(this.finalArray)) {
                console.log("Correct.");
                ImagePopup.localImagePopup("~/images/puzzleSaksofon.jpg");
                this._player.play();
                this.right = true;
            }
        }
